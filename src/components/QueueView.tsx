      ...
      {currentTrack && (
        <div
          className={`p-4 border-b ${
            isDark ? "border-zinc-700" : "border-[#aaa]"
          } ${isDark ? "bg-zinc-600/70" : "bg-zinc-400/70"}`}
        >
          <h3
        ...
        <div className="flex-1 overflow-y-auto">
          <table className="w-full text-sm">
            ...
            >
              ...
              >
                <th
                  className={`w-12 px-2 py-2 text-left text-xs font-medium ${
                    isDark ? "text-zinc-400" : "text-zinc-600"
                  }`}
                >
                  #
                ...
                <th
                  className={`w-16 px-2 py-2 text-left text-xs font-medium ${
                    isDark ? "text-zinc-400" : "text-zinc-600"
                  }`}
                >
                  Artwork
                ...
                <th
                  className={`w-[200px] px-2 py-2 text-left text-xs font-medium ${
                    isDark ? "text-zinc-400" : "text-zinc-600"
                  }`}
                >
                  Title
                ...
                <th
                  className={`w-[150px] px-2 py-2 text-left text-xs font-medium ${
                    isDark ? "text-zinc-400" : "text-zinc-600"
                  }`}
                >
                  Artist
                ...
                <th
                  className={`w-[100px] px-2 py-2 text-left text-xs font-medium ${
                    isDark ? "text-zinc-400" : "text-zinc-600"
                  }`}
                >
                  Genre
                  ...
                  <td className="px-2 py-2">
                    <div className="flex flex-col items-center gap-1">
                      <button
                        ...
                        } border border-[#E6C7FF] hover:border-[#C273FF] rounded cursor-pointer transition-colors`}
                      >
                        Play Next
                      </button>
                      <button
                        ...
                        className={`w-full px-2 py-1 text-xs ${
                          ...
                          isDark
                            ? "bg-zinc-800 hover:bg-zinc-700"
                            : "bg-zinc-100 hover:bg-zinc-200"
                        } border border-red-300 hover:border-red-400 rounded cursor-pointer transition-colors`}
                      >
                        Remove
                      </button>
                    </div>
